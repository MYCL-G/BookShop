...
const swiperSlidesData = {
	...
	data: [
		{
			id: 2,
			img_url: require('@/imgs/sliders/2.png'),
		},
		{
			id: 3,
...
const getAllKindList = {
	code: "200",
	data: [
		{
			id: 1,
			img_url: require("./imgs/book/c1.jpg"),
			title: "青春文学",
			msg: " 影视写真、穿越/重生/架空、玄幻/新武侠/魔幻/科幻"
		},
		{
			id: 2,
			img_url: require("./imgs/book/c2.jpg"),
			title: "软件编程",
			msg: " C#、PHP、Java、Android、iOS"
		}
	]
}
Mock.mock("@/book/getAllKind", "get", getAllKindList)
...
Mock.mock("@/book/getVariou", "get", getVariouList)

const getPhotosByIdList = function (options) {
	let res = [];
	switch (options.url) {
		case "@/book/getPhotosById/3":
			res = [
				{
					id: 31,
...
Mock.mock(RegExp("@/book/getPhotosById" + ".*"), "get", getPhotosByIdList)
...
const bookListData = [
	{
		id: 31,
		thumbnail: "https://img10.360buyimg.com/n1/s200x200_jfs/t3241/218/7464122794/123894/c38682fd/58b66b59N182bacd9.jpg",
		sellPrice: 79,
		title: "ASP.NET MVC企业级实战"
	},
	{
		id: 32,
		thumbnail: "https://img12.360buyimg.com/n1/s200x200_jfs/t1/39634/38/5579/168439/5cce76c5E91840de2/7d4f43307346eff4.jpg",
		sellPrice: 69,
...
Mock.mock("/book/getshopcartlist", "post", function (options) {
	...
	var _data = [];
	if (param.ids) {
		_data = bookListData.filter(book => {
			if (book.id == param.ids) {
				return book;
			}
		});
	}
